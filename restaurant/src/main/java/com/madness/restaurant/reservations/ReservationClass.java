...
public class ReservationClass {
    ...
    public ReservationClass(String id, String customerID, String restaurantID, String deliverymanID, String deliveryDate, String deliveryHour, String totalPrice, String customerAddress, String restaurantAddress, String status, String riderComment, String riderRating, String restaurantComment, String restaurantRating, List<ItemClass> cart) {
        this.id = id;
